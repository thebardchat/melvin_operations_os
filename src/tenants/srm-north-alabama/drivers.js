...
export const ALL_DRIVERS = [
  ...
  { name: 'Marcus',  crew: '507',   color: '#4FC3F7', bg: '#0a1a22', start: '05:00' },
  ...
  { name: 'Charlie', crew: '519',   color: '#A5D6A7', bg: '#0a1a0f', start: '04:15' },
  { name: 'Bryant',  crew: '519',   color: '#A5D6A7', bg: '#0a1a0f', start: '04:30' },
  { name: 'Jamie',   crew: '519',   color: '#A5D6A7', bg: '#0a1a0f', start: '04:30' },
  { name: 'Eddie',   crew: '519',   color: '#A5D6A7', bg: '#0a1a0f', start: '04:00' },
  ...
  { name: 'Alexis',  crew: '516',   color: '#FF7043', bg: '#220a00', start: '08:00', fixedBP: true, shortDay: true },
]
